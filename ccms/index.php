...
<body  class="bg-dark" style=" background-image: url('images/c5.jpg');background-size: 100% 120%; background-repeat: no-repeat;">
        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                    <h1 style="color: red"><b>Cyber Cafe Management System </b></h1>
                    <hr  color="red"/>
                </div>
