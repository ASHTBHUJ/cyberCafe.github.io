...
<body>
    ...
    echo $msg;
                            ...
                            <div class="card-body card-block">
                                ...
                                <div class="form-group"><label for="company" class=" form-control-label">System Name</label><input type="text" name="compname" value="" class="form-control" id="compname" required="true"></div>
                                                                          
                                        <div class="form-group"><label for="street" class=" form-control-label">System Locations</label><input type="text" name="comploc" value="" id="comploc" class="form-control" required="true"></div>
